...
<head>
  <meta charset="UTF-8">
  <title>Owner Dashboard – GoodPanda</title>
...
<body class="bg-gray-50 min-h-screen">
  ...
  <div class="max-w-4xl mx-auto mt-12 px-6">
    <h1 class="text-3xl font-bold text-gray-800 mb-2">Restaurant Owner Dashboard 🍽️</h1>
    <p class="text-gray-500 mb-8">You're logged in as a <span class="font-semibold text-orange-500">Restaurant Owner</span>.</p>

    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div class="bg-white rounded-2xl shadow p-6 flex flex-col items-center opacity-60 cursor-not-allowed">
        <i data-feather="home" class="w-10 h-10 text-orange-400 mb-3"></i>
        <h2 class="font-bold text-lg text-gray-700">My Restaurant</h2>
        <p class="text-sm text-gray-400 mt-1 text-center">Coming soon</p>
      </div>
      <div class="bg-white rounded-2xl shadow p-6 flex flex-col items-center opacity-60 cursor-not-allowed">
        <i data-feather="list" class="w-10 h-10 text-orange-400 mb-3"></i>
        <h2 class="font-bold text-lg text-gray-700">Menu Manager</h2>
        <p class="text-sm text-gray-400 mt-1 text-center">Coming soon</p>
      </div>
      <div class="bg-white rounded-2xl shadow p-6 flex flex-col items-center opacity-60 cursor-not-allowed">
        <i data-feather="bar-chart-2" class="w-10 h-10 text-orange-400 mb-3"></i>
        <h2 class="font-bold text-lg text-gray-700">Orders & Revenue</h2>
        <p class="text-sm text-gray-400 mt-1 text-center">Coming soon</p>
      </div>
    </div>
  </div>
